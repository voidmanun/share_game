...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const monsterSvgs: Record<string, string> = {
    'Basic': `<svg width="40" height="40" viewBox="0 0 40 40"><path d="M10 25 Q5 15 20 10 Q35 15 30 25 Q32 30 25 28 Q20 32 15 28 Q8 30 10 25" fill="#39FF14" stroke="#000" stroke-width="2"/><circle cx="20" cy="16" r="6" fill="#fff" stroke="#000" stroke-width="2"/><ellipse cx="20" cy="16" rx="2" ry="5" fill="#000"/><circle cx="19" cy="14" r="1.5" fill="#ff0000"/><line x1="20" y1="10" x2="18" y2="4" stroke="#000" stroke-width="2"/><line x1="20" y1="10" x2="22" y2="4" stroke="#000" stroke-width="2"/><circle cx="18" cy="4" r="2" fill="#FF3333" stroke="#000" stroke-width="1"/><circle cx="22" cy="4" r="2" fill="#FF3333" stroke="#000" stroke-width="1"/></svg>`,
    'Scout': `<svg width="40" height="40" viewBox="0 0 40 40"><polygon points="30,20 10,10 10,30" fill="#00FFFF" stroke="#000" stroke-width="3"/><circle cx="23" cy="20" r="3" fill="#fff" stroke="#000" stroke-width="1"/><circle cx="24" cy="20" r="1.5" fill="#000"/></svg>`,
    'Swarm': `<svg width="40" height="40" viewBox="0 0 40 40"><circle cx="20" cy="10" r="5" fill="#AA44AA" stroke="#000" stroke-width="2"/><circle cx="12" cy="18" r="4" fill="#AA44AA" stroke="#000" stroke-width="2"/><circle cx="28" cy="18" r="4" fill="#AA44AA" stroke="#000" stroke-width="2"/><circle cx="16" cy="28" r="4" fill="#AA44AA" stroke="#000" stroke-width="2"/><circle cx="24" cy="28" r="4" fill="#AA44AA" stroke="#000" stroke-width="2"/><circle cx="20" cy="10" r="2" fill="#fff"/><circle cx="12" cy="18" r="2" fill="#fff"/><circle cx="28" cy="18" r="2" fill="#fff"/></svg>`,
  ...
  const petSvgs: Record<string, string> = {
    ...
    'Magic Fairy': `<svg width="40" height="40" viewBox="0 0 40 40"><ellipse cx="20" cy="24" rx="6" ry="8" fill="#FF99CC" stroke="#000" stroke-width="2"/><circle cx="20" cy="14" r="7" fill="#FF99CC" stroke="#000" stroke-width="2"/><path d="M14 16 Q8 10 14 6 Q20 2 20 6" fill="#66FF66" stroke="#000" stroke-width="1"/><path d="M26 16 Q32 10 26 6 Q20 2 20 6" fill="#66FF66" stroke="#000" stroke-width="1"/><circle cx="17" cy="13" r="1.5" fill="#000"/><circle cx="23" cy="13" r="1.5" fill="#000"/><ellipse cx="20" cy="17" rx="2" ry="1" fill="#FF6699"/></svg>`,
    'Speedy Turtle': `<svg width="40" height="40" viewBox="0 0 40 40"><ellipse cx="20" cy="26" rx="14" ry="8" fill="#44AA44" stroke="#000" stroke-width="3"/><path d="M10 18 Q20 8 30 18" fill="#228822" stroke="#000" stroke-width="3"/><circle cx="20" cy="12" r="6" fill="#228822" stroke="#000" stroke-width="2"/><circle cx="18" cy="11" r="1.5" fill="#000"/><circle cx="22" cy="11" r="1.5" fill="#000"/><ellipse cx="20" cy="14" rx="2" ry="1" fill="#006600"/><line x1="12" y1="30" x2="8" y2="36" stroke="#228822" stroke-width="3"/><line x1="28" y1="30" x2="32" y2="36" stroke="#228822" stroke-width="3"/></svg>`,
    'Grumpy Porcupine': `<svg width="40" height="40" viewBox="0 0 40 40"><circle cx="20" cy="22" r="10" fill="#666666" stroke="#000" stroke-width="3"/><line x1="20" y1="12" x2="20" y2="4" stroke="#888888" stroke-width="3"/><line x1="14" y1="14" x2="8" y2="8" stroke="#888888" stroke-width="3"/><line x1="26" y1="14" x2="32" y2="8" stroke="#888888" stroke-width="3"/><line x1="10" y1="22" x2="4" y2="20" stroke="#888888" stroke-width="3"/><line x1="30" y1="22" x2="36" y2="20" stroke="#888888" stroke-width="3"/><circle cx="16" cy="20" r="2" fill="#fff"/><circle cx="24" cy="20" r="2" fill="#fff"/><circle cx="16" cy="20" r="1" fill="#000"/><circle cx="24" cy="20" r="1" fill="#000"/><path d="M17 26 Q20 28 23 26" stroke="#000" stroke-width="2" fill="none"/></svg>`,
    'Bouncy Slime': `<svg width="40" height="40" viewBox="0 0 40 40"><path d="M8 28 Q4 18 12 12 Q20 4 28 12 Q36 18 32 28 Q20 34 8 28" fill="#33CC33" stroke="#000" stroke-width="3"/><circle cx="15" cy="16" r="3" fill="#fff"/><circle cx="25" cy="16" r="3" fill="#fff"/><circle cx="15" cy="16" r="1.5" fill="#000"/><circle cx="25" cy="16" r="1.5" fill="#000"/><ellipse cx="20" cy="22" rx="4" ry="2" fill="#229922"/></svg>`,
