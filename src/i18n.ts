...
export const translations = {
  en: {
    ...
    weaponPoisonGun: 'Poison Gun',
    weaponFreezeGun: 'Freeze Gun',
    enemyTitan: 'Titan',
    ...
    descPoisonGun: 'Poisons enemies, preventing them from healing',
    descFreezeGun: 'Freezes enemies for 3s, followed by 4s of slowness',
  ...
  zh: {
    ...
    descPoisonGun: '使敌人中毒，阻止其恢复生命',
    descFreezeGun: '冻结敌人3秒，随后持续4秒减速',
